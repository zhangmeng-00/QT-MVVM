...
public:
    ...
    QGroupBox *groupLogList;
    QVBoxLayout *verticalLayoutLogList;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupLogList = new QGroupBox(centralwidget);
        groupLogList->setObjectName(QString::fromUtf8("groupLogList"));
        verticalLayoutLogList = new QVBoxLayout(groupLogList);
        verticalLayoutLogList->setObjectName(QString::fromUtf8("verticalLayoutLogList"));
        logListView = new LogListView(groupLogList);
        logListView->setObjectName(QString::fromUtf8("logListView"));

        verticalLayoutLogList->addWidget(logListView);


        verticalLayoutMain->addWidget(groupLogList);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        groupLogList->setTitle(QCoreApplication::translate("MainWindow", "Log List", nullptr));
    } // retranslateUi
